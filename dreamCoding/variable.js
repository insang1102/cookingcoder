...
// 4. Variable types
// primitive, single item: number, string, boolean, undefined, NaN, null, symbols --> which can't be divided anymore
// object, box container --> possible to include multiple items
...
console.log(nAn);
// These are vital in workplace a lot because they cause plenty of eroors whilst developing unless you skip and ignore in advance

// bigInt ( fairly new, do not use it yet)
const bigInt = 8371289758943835-032490238901582375820n; // 'n' makes it recognise as 'bigInt'
...
text = '8' / '2';
console.log('value: ${text}, type: ${typeof text}');
console.log(text.charAt(0)); // error --> type is set during runtime in javascript,, that's why TS is popped up
